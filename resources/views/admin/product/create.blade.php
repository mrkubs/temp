                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama"
                                        ...
                                        id="productNama" aria-describedby="emailHelp">
                                    @error('nama')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="harga"
                                        ...
                                        value="{{ old('harga') }}" id="productNama" aria-describedby="emailHelp">
                                    @error('harga')
                                        <div class="invalid-feedback text-danger">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select form-select-mb @error('is_ready') is-invalid @enderror"
                                        ...
                                        <option value="1" {{ old('is_ready') == 1 ? ' selected' : '' }}>Product
                                            Tersedia</option>
                                        <option value="0" {{ old('is_ready') == 0 ? ' selected' : '' }}>Product Tidak
                                            Tersedia</option>
                                    </select>
                                    @error('is_ready')
                                        <div class="invalid-feedback text-danger">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="description"
                                        ...
                                        value="{{ old('description') }}" id="productDesc" aria-describedby="emailHelp">
                                    @error('description')
                                        <div class="invalid-feedback text-danger">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select form-select-mb @error('jenis') is-invalid @enderror"
                                        ...
                                        <option value="makanan" {{ old('jenis') == 'makanan' ? ' selected' : '' }}>
                                            makanan</option>
                                        <option value="minuman" {{ old('jenis') == 'minuman' ? ' selected' : '' }}>
                                            minuman</option>
                                        <option value="soup" {{ old('jenis') == 'soup' ? ' selected' : '' }}>soup
                                        </option>
                                    </select>
                                </div>
